package core.reactor
{
	...
	public class CameraReactor extends BaseReactor
	{
		...
		public function CameraReactor(delegate:DelegateCollector):void
		{
			...
			_captureEnabled = delegate.cameraColor.hasFunction;
			if (_captureEnabled || delegate.cameraAction.hasFunction)
			{
				_camera = getCamera();
		...
		private function _enterFrameHandler(event:Event):void
		{
			...
			{
				_captureColor();
				delegate.cameraColor.execute(_captureColorHSV.h, _captureColorHSV.s, _captureColorHSV.v);
			}
		}
